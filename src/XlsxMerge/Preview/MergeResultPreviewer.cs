            ...
            MergeResultPreviewData previewData)
        {
            ...
            try
            {
                ...
                for (int i = 1; i <= unifiedColumnWidthList.Count; i++)
                {
                    ...
                    dataGridView.Columns.Add("C" + i, columnName + "::[]");
                    dataGridView.Columns["C" + i].Width = columnWidth;
                }
                ...
                using Font strikeoutFont = new Font(SystemFonts.DefaultFont, FontStyle.Strikeout);
                ...
                for (int currentRowIdx = 0; currentRowIdx < cachedTempPreviewLines.Count; currentRowIdx++)
                {
                    ...
                    if (refWorksheet == null || refWorksheet.GetRowCount() == 0)
                        continue;
                    ...
                    for (int cellNumber = 1; cellNumber <= maxColumn; cellNumber++)
                    {
                        ...
                        var currentCellDgv = dgvRow.Cells["C" + cellNumber];
